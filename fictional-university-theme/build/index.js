...
/* -------------------JQUERY POWERED VERSION
import $ from 'jquery';



class Search {
    // 1. describing and initiating our object. Properties will be created here.
    constructor() {
        this.link404 = $("#searchLink404");
        this.addSearchHTML();
        this.resultsDiv = $("#search-overlay__results");
        //the this word below refers to the current object. 
    ...
    events() {
        ...
        //for 404.php;
        this.link404.on("click", this.openOverlay.bind(this));
    }
...
//in this getResults method, two json data is combined as below to provide search results from both posts types.
    getResults() {
    ...
    keyPressDispatcher(e) {
        ...
        if(e.key == "Escape" && this.isOverlayOpen == true) {
            this.closeOverlay();
        }
    }
